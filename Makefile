...
ACLOCAL = ${SHELL} /home/chenhanbing/workspace/libevent-2.0.21-stable/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /home/chenhanbing/workspace/libevent-2.0.21-stable/missing --run autoconf
AUTOHEADER = ${SHELL} /home/chenhanbing/workspace/libevent-2.0.21-stable/missing --run autoheader
AUTOMAKE = ${SHELL} /home/chenhanbing/workspace/libevent-2.0.21-stable/missing --run automake-1.11
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/chenhanbing/workspace/libevent-2.0.21-stable/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
ZLIB_LIBS = -lz 
abs_builddir = /home/chenhanbing/workspace/libevent-2.0.21-stable
abs_srcdir = /home/chenhanbing/workspace/libevent-2.0.21-stable
abs_top_builddir = /home/chenhanbing/workspace/libevent-2.0.21-stable
abs_top_srcdir = /home/chenhanbing/workspace/libevent-2.0.21-stable
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
acx_pthread_config = 
...
install_sh = ${SHELL} /home/chenhanbing/workspace/libevent-2.0.21-stable/install-sh
